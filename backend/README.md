...
### Instalando Srping Tool Suite:
Acesse o site https://spring.io/tools e siga todos os passos de instalação.

### criar as entidades e o seed do banco:

**Modelo conceitual**

![](https://github.com/devsuperior/bds-assets/raw/main/sds/sds3-mc.png) créditos:Escola DevSuperior
